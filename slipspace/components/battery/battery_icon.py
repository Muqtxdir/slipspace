...
@Gtk.Template(
    resource_path="/com/muqtxdir/slipspace/components/battery/battery-icon.ui"
)
class BatteryIcon(Adw.Bin):
    ...
    def __init__(self, battery: Battery = None, **kwargs):
        ...
        self._battery.bind_property(
            "label", self, "label", GObject.BindingFlags.SYNC_CREATE
        )
        self._battery.bind_property(
            "show-percentage", self, "show-percentage", GObject.BindingFlags.SYNC_CREATE
        )
        self._battery.bind_property(
